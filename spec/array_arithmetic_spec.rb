RSpec.describe ArrayArithmetic do
  ...
  describe "add" do
    ...
    it "raises an error if the first argument is not an array" do
      arr_two = [9, 8, 7, 6, 5]
      expect{add(5, arr_two)}.to raise_error(ArgumentError, 'Argument is not an array')
    end
  end
  ...
  describe "subtract" do
    ...
    it "raises an error if the first argument is not an array" do
      arr_two = [9, 8, 7, 6, 5]
      expect{subtract(5, arr_two)}.to raise_error(ArgumentError, 'Argument is not an array')
    end
  end
  ...
  describe "multiply" do
    ...
    it "raises an error if the first argument is not an array" do
      arr_two = [9, 8, 7, 6, 5]
      expect{multiply(5, arr_two)}.to raise_error(ArgumentError, 'Argument is not an array')
    end
  end
  ...
  describe "divide" do
    ...
    it "raises an error if the first argument is not an array" do
      arr_two = [9, 8, 7, 6, 5]
      expect{divide(5, arr_two)}.to raise_error(ArgumentError, 'Argument is not an array')
    end
  end
  ...
  describe "remainder" do
    ...
    it "raises an error if the first argument is not an array" do
      arr_two = [9, 8, 7, 6, 5]
      expect{remainder(5, arr_two)}.to raise_error(ArgumentError, 'Argument is not an array')
    end
  end
  ...
  describe "exponential" do
    it "raises the values of the first array to the power provided" do
      ...
      expect(exponential(arr_one, 3)).to eq(result)
    end
    ...
    it "raises the values of the first array to the power of the corresponding indices of the second array" do
      ...
      expect(exponential(arr_one, arr_two)).to eq(result)
    end

    it "raises an error if the first argument is not an array" do
      arr_two = [9, 8, 7, 6, 5]
      expect{exponential(5, arr_two)}.to raise_error(ArgumentError, 'Argument is not an array')
    end
  end
